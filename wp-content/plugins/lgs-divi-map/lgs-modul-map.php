<?php
class Mapa extends ET_Builder_Module {
    function init() {
        $this->name            = esc_html__( 'Mapa', 'et_builder' );
        $this->slug            = 'et_pb_mapa';
    ...
    function get_fields() {
        $fields = array(
            ...
            'our_styles' => array(
                'label'           => esc_html__( 'asdfghjk', 'et_builder' ),
                'type'            => 'yes_no_button',
                'option_category' => 'configuration',
                'options'         => array(
                    'off' => esc_html__( 'No', 'et_builder' ),
            ...
            'my_styles' => array(
                'label'       => esc_html__( 'My styles', 'et_builder' ),
                'type'        => 'textarea',
                'description' => esc_html__( 'Use custom Google Map styles.', 'et_builder' ),
                'toggle_slug' => 'admin_label',
//                'option_category' => 'configuration',
//                'tab_slug'    => 'advanced',
//                'toggle_slug' => 'filter',
    ...
    function shortcode_callback($atts, $content = null, $function_name ) {
        ...
        $my_styles_amount        = $this->shortcode_atts['my_styles'];
        ...
        $output = sprintf(
            '<div%5$s class="et_pb_module et_pb_mapa_container%6$s"%8$s>
				<div class="et_pb_mapa" data-center-lat="%1$s" data-center-lng="%2$s" data-zoom="%3$d" data-mouse-wheel="%7$s" data-mobile-dragging="%9$s" my_styles_amount="%10$s"></div>
				%4$s
			</div>',
